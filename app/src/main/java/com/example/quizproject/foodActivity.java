...
public class foodActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btnAnswer1,btnAnswer2,btnAnswer3,btnAnswer4,btnStartQuiz,btnBackToQuestion,btnUseTheHelpPhone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question1= new Question(getString(R.string.question1), new String[]{getString(R.string.question1Ans1), getString(R.string.question1Ans2), getString(R.string.question1Ans3), getString(R.string.question1Ans4)},3,false);
        ...
        question5= new Question(getString(R.string.question5), new String[]{getString(R.string.question5Ans1), getString(R.string.question5Ans2), getString(R.string.question5Ans3), getString(R.string.question5Ans4)},1,false);
        question6= new Question(getString(R.string.question6), new String[]{getString(R.string.question6Ans1), getString(R.string.question6Ans2), getString(R.string.question6Ans3), getString(R.string.question6Ans4)},3,false);
        question7= new Question(getString(R.string.question7), new String[]{getString(R.string.question7Ans1), getString(R.string.question7Ans2), getString(R.string.question7Ans3), getString(R.string.question7Ans4)},3,false);
        question8= new Question(getString(R.string.question8), new String[]{getString(R.string.question8Ans1), getString(R.string.question8Ans2), getString(R.string.question8Ans3), getString(R.string.question8Ans4)},4,false);
    ...
    public void startQuiz(){
        if (numOfQuestionsAsked!=questionsArr.length) {
            ...
            btnAnswer1.setText("" + questionsArr[indexOfCurrentQuestion].getAnswersArr()[0]);
            btnAnswer2.setText("" + questionsArr[indexOfCurrentQuestion].getAnswersArr()[1]);
            btnAnswer3.setText("" + questionsArr[indexOfCurrentQuestion].getAnswersArr()[2]);
            btnAnswer4.setText("" + questionsArr[indexOfCurrentQuestion].getAnswersArr()[3]);
                    ...
                    if (document.exists()) {
                        if (document.getData().get(currentUser.getEmail())!=null) {
                            ...
                            if (sumOfPoints>numHighestPoint){
                                ...
                                db.collection("Users").document("usersDetail")//משנה במסמך של המשתמשים את הנקודות העדכניות
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                Toast.makeText(foodActivity.this," כל הכבוד השגת "+sumOfPoints+" נקודות ",Toast.LENGTH_SHORT).show();
                                                Intent it=new Intent(foodActivity.this,winnersActivity.class);
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                Toast.makeText(foodActivity.this,"אוי חבל לא עבד",Toast.LENGTH_SHORT).show();
                                                loadingpage.cancel();
                                            }
                                        });
                                ...
                                Toast.makeText(foodActivity.this, " כל הכבוד השגת " + sumOfPoints + " נקודות היו לך פעמים יותר טובות", Toast.LENGTH_SHORT).show();
                                Intent it=new Intent(foodActivity.this,winnersActivity.class);//לא משנה כלום ב SHERED כי כבר מופיע התוצאה הכי טובה שלו
                                it.putExtra("points",-1);//מעביר לעמוד הבא את המספר -1 כדי שידע שלא שיפר תוצאה
                                startActivity(it);
                            }
                        }
                    } else {
                        Toast.makeText(foodActivity.this, "No such document",Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(foodActivity.this, "get failed with ",Toast.LENGTH_SHORT).show();
                }
            }
        });
